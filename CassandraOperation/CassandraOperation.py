...
class dBOperation:
    ...
    def __init__(self):
        ...
        self.secure_connect_bundle = 'secure-connect-south-german-bank-data.zip'
        self.client_id = 'vKBlplClHDsyyaKihZrFROLZ'
        self.client_secret = '7SSK4XtvAzdU2eOKXfmG+mXoO4,iX9H.BG2mLJ3.ZmPtqJKj2OuZxNA6zyt_xktpFHlR7NbIoOtA2XruJkW-Hs4mwEt46IuJ.qmHdvL_QU1NgLfPKxkDH,yd8ZO-MI,I'
